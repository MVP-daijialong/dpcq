...
<div class="container">
    ...
    <script>
        ...
        function use(id, item_id, item_name) {
            layer.confirm('确定要使用[' + item_name + ']吗？', {
                icon: 3,
                title: '确认',
            }, function(index){
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({id: id, item_id: item_id}),
        ...
        function sell(id, item_id, item_name, type) {
            ...
            layer.confirm('确定要'+ text + item_name +']吗？', {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({id: id, item_id: item_id, type: type, sell_type: 2}),
                    success: function (data) {
                        if (data.success) {
                            layer.msg(data.msg)
                            setTimeout(function() {
