    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md7 layui-col-md-offset3">
            <div class="layui-card">
                <div class="layui-card-header layui-text-center" style="font-size: 24px;">注册账号</div>
                <div class="layui-card-body">
                    <form method="POST" action="{{ route('register') }}" class="layui-form">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input id="password-confirm" type="password" class="layui-input" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block">
                                <p>已有账号？去<a href="/login" style="color: #01AAED">登录</a></p>
